...
from store.apis import CartAPIs
...
def razorpay(request):
    ...
    order_details_in_cart = order_item_service.get_items_by_order_id(order.id)
    items_total = order_item_service.get_items_total(order_details_in_cart)
    payable_amount = order_item_service.get_payable_amount(
        order_details_in_cart, items_total, None) + order_item_service.get_delivery_charge(items_total, order)
